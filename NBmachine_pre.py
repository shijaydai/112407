...
# 讀取CSV檔案
spam_dataframe = pd.read_csv('/Users/asus-fa506/archive/Gappdj_en.csv', encoding='utf-8')
...
# 將結果存儲為 CSV 檔案
spam_dataframe.to_csv('/Users/asus-fa506/archive/Gappdj_en_pre.csv', index=False, encoding='utf-8-sig')